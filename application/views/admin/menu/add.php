...
<div id="page-content-wrapper">
    <div id="page-title"><h3>Add Menu</h3></div><!-- #page-title -->
...
<div id="page-content">
        <div class="example-box">
            <div class="example-code">
                <form id="category-form" action="<?php echo base_url(); ?>index.php/admin/menu/add/" class="col-md-10 center-margin" method="post">
                    <div class="form-row">
                     ...
                     <div class="form-row">
                        ...
                        <div class="form-input col-md-3">
                            <input type="text" id="menu_name" name="menu_name" data-required="true" class="parsley-validated">
                        </div>
                    </div>
                   
                    <div class="form-row">
                        <div class="form-input col-md-3 col-md-offset-2">
                               <input type="submit" name="submit_menu" value="Add Menu" class="btn medium primary-bg radius-all-4 button-content" id="demo-form-2-valid" onclick="javascript:$('#category-form').parsley( 'validate' );">                    
                        </div>
                    </div>
                </form>
            </div>
