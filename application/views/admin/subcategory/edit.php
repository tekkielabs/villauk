...
<div id="page-content-wrapper">
    <div id="page-title"><h3>Edit Sub Category</h3></div><!-- #page-title -->
    ...
    ?>       
       <div class="infobox bg-green">
            ...
            <p>Sub Category has been successfully edited.</p>
        </div>
...
<div id="page-content">
        <div class="example-box">
            <div class="example-code">
                <form id="category-form" action="<?php echo base_url(); ?>subcategory/edit/<?php echo $this->uri->segment(3); ?>" class="col-md-10 center-margin" method="post">
                    <div class="form-row">
                        ...
                        <div class="form-input col-md-3">
                            <input type="text" id="subcategory_name" name="subcategory_name" data-required="true" class="parsley-validated" value="<?php echo $category_info['name']; ?>">
                        </div>
                    </div>
